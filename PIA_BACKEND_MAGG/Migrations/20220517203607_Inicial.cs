    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_usuarioRifa", x => x.Id);
                    table.ForeignKey(
                        name: "FK_usuarioRifa_participantes_participanteId",
                        column: x => x.participanteId,
                        principalTable: "participantes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_usuarioRifa_rifas_rifaId",
                        column: x => x.rifaId,
                        principalTable: "rifas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_usuarioRifa_participanteId",
                table: "usuarioRifa",
                column: "participanteId");

            migrationBuilder.CreateIndex(
                name: "IX_usuarioRifa_rifaId",
                table: "usuarioRifa",
                column: "rifaId");
        }
